...
const FIXED_HOLIDAYS: Omit<Holiday, 'date'> & { month: number; day: number }[] = [
  ...
  { name: 'Mahavir Jayanti', month: 4, day: 14, type: 'festival', color: '#FF6B35' },
  { name: 'Good Friday', month: 4, day: 18, type: 'national', color: '#8B4513' },
  { name: 'Labour Day', month: 5, day: 1, type: 'national', color: '#E63946' },
  { name: 'Independence Day', month: 8, day: 15, type: 'national', color: '#138808' },
...
const VARIABLE_HOLIDAYS: Record<number, Holiday[]> = {
  2024: [
    ...
    { name: 'Buddha Purnima', date: '05-23', type: 'festival', color: '#FFD700' },
    { name: 'Eid ul-Adha', date: '06-17', type: 'festival', color: '#00BCD4' },
    { name: 'Raksha Bandhan', date: '08-19', type: 'festival', color: '#FF69B4' },
    ...
    { name: 'Guru Nanak Jayanti', date: '11-15', type: 'festival', color: '#FF8C00' },
  ],
  2025: [
    ...
    { name: 'Buddha Purnima', date: '05-12', type: 'festival', color: '#FFD700' },
    { name: 'Eid ul-Adha', date: '06-07', type: 'festival', color: '#00BCD4' },
    { name: 'Raksha Bandhan', date: '08-09', type: 'festival', color: '#FF69B4' },
    ...
    { name: 'Guru Nanak Jayanti', date: '11-05', type: 'festival', color: '#FF8C00' },
  ],
  2026: [
    ...
    { name: 'Buddha Purnima', date: '05-31', type: 'festival', color: '#FFD700' },
    { name: 'Eid ul-Adha', date: '05-27', type: 'festival', color: '#00BCD4' },
    { name: 'Raksha Bandhan', date: '08-28', type: 'festival', color: '#FF69B4' },
